...
/* harmony import */ var _theme_control__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./theme-control */ "./source/js/modules/theme-control.js");
...
class FullPageScroll {
  constructor() {
    ...
    this.historyScreen = document.querySelector(`.screen--story`);
    this.prizesScreen = document.querySelector(`.screen--prizes`);
    this.themeControl = new _theme_control__WEBPACK_IMPORTED_MODULE_1__["default"]();
  ...
  onUrlHashChanged() {
    ...
    this.addBackground = this.activeScreen === 1 && newIndex === 2;
  ...
  changePageDisplay() {
    if (this.addBackground) {
      ...
      this.historyScreen.classList.add(`bg-active`);
      this.prizesScreen.classList.add(`bg-active`);

      setTimeout(() => {
        this.changeVisibilityDisplay();
        this.changeActiveMenuItem();
        this.emitChangeDisplayEvent();
        this.historyScreen.classList.remove(`bg-active`);
      }, 500);

    } else {
      this.backgroundScreen.classList.remove(`active`);
      this.prizesScreen.classList.remove(`bg-active`);
      this.changeVisibilityDisplay();
      this.changeActiveMenuItem();
      this.emitChangeDisplayEvent();
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _theme_control__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./theme-control */ "./source/js/modules/theme-control.js");

const themeControl = new _theme_control__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
const themeControl = new _theme_control__WEBPACK_IMPORTED_MODULE_1__["default"]();
        ...
        on: {
          slideChange: () => {
            if (storySlider.activeIndex === 0 || storySlider.activeIndex === 1) {
              sliderContainer.style.backgroundImage = `url("img/slide1.jpg"), linear-gradient(180deg, rgba(83, 65, 118, 0) 0%, #523E75 16.85%)`;
              themeControl.removeThemeClasses();
              themeControl.addFirstThemeClass();
              ...
              themeControl.removeThemeClasses();
              themeControl.addSecondThemeClass();
              ...
              themeControl.removeThemeClasses();
              themeControl.addThirdThemeClass();
            } else if (storySlider.activeIndex === 6 || storySlider.activeIndex === 7) {
              sliderContainer.style.backgroundImage = `url("img/slide4.jpg"), linear-gradient(180deg, rgba(45, 39, 63, 0) 0%, #2F2A42 16.85%)`;
              themeControl.removeThemeClasses();
              themeControl.addFourthThemeClass();
            }
          },
          resize: () => {
            storySlider.update();
...
/***/ "./source/js/modules/theme-control.js":
/*!********************************************!*\
  !*** ./source/js/modules/theme-control.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ThemeControl; });
